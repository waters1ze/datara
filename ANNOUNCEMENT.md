...
```markdown
Hi HN! We are releasing Datara v1.0.0, a new compiled systems and application programming language written in Rust with dual backends (Cranelift for 30ms dev builds and LLVM -O3 for production).

Repository: https://github.com/waters1ze/datara
Release & Installers: https://github.com/waters1ze/datara/releases/tag/v1.0.0
...
After extensive engineering, we're publicly launching **Datara v1.0.0** — an open-source systems and application programming language built in Rust:
...
```text
 Релиз языка программирования Datara v1.0.0!
