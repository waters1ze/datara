...
impl ReplSession {
    ...
    pub fn eval_block(&mut self, block: &str) -> Option<String> {
        ...
        // Top-level declaration: fn, class, entity, behavior, role, component, packet, enum, use, extern, trait, impl, struct
        ...
        if matches!(
            ...
            crate::lexer::TopLevelKind::Fn
                ...
                | crate::lexer::TopLevelKind::Component
                | crate::lexer::TopLevelKind::Packet
                | crate::lexer::TopLevelKind::Enum
                | crate::lexer::TopLevelKind::Use
                | crate::lexer::TopLevelKind::Extern
                | crate::lexer::TopLevelKind::Trait
                | crate::lexer::TopLevelKind::Impl
                | crate::lexer::TopLevelKind::Struct
        ) {
