...
Get-ChildItem -Path "$ProjectRoot\src\runtime" -File | Where-Object { $_.Extension -in '.h', '.c' } | ForEach-Object { Copy-Item -Force $_.FullName "$WinStaging\runtime" }
...
Get-ChildItem -Path "$ProjectRoot\src\runtime" -File | Where-Object { $_.Extension -in '.h', '.c' } | ForEach-Object { Copy-Item -Force $_.FullName "$LinuxStaging\runtime" }
...
Get-ChildItem -Path "$ProjectRoot\src\runtime" -File | Where-Object { $_.Extension -in '.h', '.c' } | ForEach-Object { Copy-Item -Force $_.FullName "$DarwinStaging\runtime" }
